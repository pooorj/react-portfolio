    ...
    <section id="contact">
      ...
      <div>
        <div className="box">
          ...
          <a href="mailto:purnamaanugrah98@gmail.com">purnamaanugrah98@gmail.com</a>
        </div>
        <div className="box">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z" /></svg>
          <a href="tel:0738 12 23 34">081818948484</a>
        </div>
        <br />
        <div className="box">
          ...
          <a href="https://www.google.com/maps/place/Kendari,+Kota+Kendari,+Sulawesi+Tenggara/@-3.985049,122.5020254,13z/data=!3m1!4b1!4m5!3m4!1s0x2d98ecde0b6b7183:0x1397347f9e562fc7!8m2!3d-3.9984597!4d122.5129742">Kendari, Indonesia</a>
        </div>
      </div>
    </section>
  );
